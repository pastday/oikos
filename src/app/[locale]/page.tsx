 ...
 * 콘텐츠는 아직 DB에서 읽지 않고 src/content/home 의 데이터 파일에서 가져온다.
 */
export default async function HomePage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <ProgramCards content={content} />
      <OnlineSection content={content} />
      <CurriculumPreview locale={locale} content={content} />
      <FacultyPreview locale={locale} content={content} />
