...
export function createPagesKo(
  ...
  about: {
    ...
    presidentNotice: {
      title: "총장 인사말",
      body: [
        "오이코스대학교 경영대학원 홈페이지를 방문해 주신 여러분을 진심으로 환영합니다.",
        "오늘날의 경영 환경은 빠르게 변화하고 있으며, 호텔·외식·와인 및 관광서비스 산업 또한 글로벌 시장의 변화와 새로운 소비문화에 맞추어 끊임없이 발전하고 있습니다. 이러한 시대에는 이론적 지식뿐만 아니라 현장을 이해하고 변화를 이끌어 갈 수 있는 실무 중심의 전문성과 국제적 시각이 더욱 중요합니다.",
        "오이코스대학교 경영대학원은 호텔·외식·와인경영 분야를 중심으로, 현업과 학업을 함께 이어가고자 하는 분들에게 체계적인 학습 기회를 제공하고자 합니다. MBA와 DBA 과정은 경영학의 기본 이론을 바탕으로 실제 산업 현장에서 활용할 수 있는 전문지식과 문제해결 역량을 함양하는 데 초점을 두고 있습니다.",
        "특히 온라인으로 운영되는 교육과정을 통해 시간과 장소의 제약을 줄이고, 다양한 경험을 가진 학습자들이 자신의 전문 분야를 더욱 발전시킬 수 있도록 돕고자 합니다. 학문적 깊이와 실무적 통찰을 함께 갖춘 인재를 양성하는 것이 우리 대학원이 추구하는 중요한 교육 방향입니다.",
        "배움은 새로운 가능성을 여는 출발점입니다. 오이코스대학교 경영대학원에서 여러분의 경험과 전문성을 한 단계 더 발전시키고, 변화하는 글로벌 경영환경 속에서 새로운 가치를 만들어 가시기를 바랍니다.",
        "여러분의 도전과 성장을 응원합니다.",
        "감사합니다.",
      ].join("\n\n"),
    },
  ...
  admission: {
    ...
    admissionFee: {
      ...
      paragraphs: [
        "입학원서 제출 시 입학허가비를 납부합니다.",
        "납부된 입학허가비는 취합 후 미화(USD)로 일괄 송금되며, 입학 심사를 거쳐 입학허가서가 발급된 후 등록금을 납부하게 됩니다.",
      ],
      notes: [
        "입학허가비와 등록금은 별도입니다.",
        "자세한 납부계좌는 온라인 입학신청 최종 제출 후 안내됩니다.",
      ],
    },
  },
