...
>
> 마지막 갱신: 2026-08-19 · 13단계(디자인 B안 전면 재설계 + 시안 이미지) 완료
...
실제로 글자 폭을 재서 확인했다. (DejaVu Serif Bold — Georgia 보다 넓어 보수적)

| 화면 폭 | 칸 폭 | 글자 크기 | ONLINE 폭 | 여유 |
| --- | --- | --- | --- | --- |
| 1920 / 1440px | 719px | 129px | 575px | 20% |
| 1024 / 768px | 688px | 124px | 553px | 20% |
| 390px | 342px | 62px | 278px | 19% |
| 320px | 272px | 49px | 219px | 19% |
